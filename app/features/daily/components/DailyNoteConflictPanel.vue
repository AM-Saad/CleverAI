<template>
  <UiPanel variant="subtle" size="sm" tone="warning" content-class="text-content-on-surface overflow-auto!">
    ...
    <div class="grid gap-3 md:grid-cols-2">
      <div class="min-w-0">
        ...
        <div class=" overflow-auto rounded-[var(--radius-md)] bg-surface p-2 text-xs text-content-secondary">
    ...
    <div class="mt-3 flex flex-wrap gap-2">
      <UiButton size="xs" tone="primary" variant="soft" @click="$emit('resolve', 'keep-local')">
        Keep mine
      </UiButton>
      <UiButton size="xs" tone="neutral" variant="soft" @click="$emit('resolve', 'keep-server')">
        Use server
      </UiButton>
    </div>
  </UiPanel>
