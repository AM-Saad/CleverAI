<template>
  <shared-page-wrapper :title="pageTitle" :subtitle="pageSubtitle">
    ...
    <div
      ...
      class="mb-6 flex flex-col sm:flex-row sm:items-center justify-between gap-4 rounded-xl border border-primary/20 bg-primary/5 p-4"
    >
      ...
      <u-button size="xs" variant="soft" to="/language/review" class="w-fit">
