    ...
    <UiModal v-model:open="showModal" title="Stay on Track with Your Learning" icon="bell"
      ...
      <template #body>
        ...
        <div class="space-y-3 mb-6">
          <div class="flex items-start gap-3">
            <UiIcon name="circle-check" class="w-5 h-5 text-success-text mt-0.5 shrink-0" />
            <div>
          ...
          <div class="flex items-start gap-3">
            <UiIcon name="circle-check" class="w-5 h-5 text-success-text mt-0.5 flex-shrink-0" />
            <div>
              <div class="text-sm font-medium text-content-on-surface-strong dark:text-content-on-surface">
        ...
        <UiPanel v-if="permissionStatus === 'denied'"
          ...
          <div class="flex items-start gap-2">
            <UiIcon name="triangle-alert" class="w-5 h-5 text-error-text mt-0.5 flex-shrink-0" />
            <div>
      ...
      <template #footer>
        <div class="space-y-3">
          <UiButton :loading="isLoading" :disabled="permissionStatus === 'denied'" tone="primary" size="lg" block
            ...
            <template v-if="isLoading">
              <UiIcon name="refresh-cw" class="w-4 h-4 animate-spin mr-2" />
              Setting up notifications...
            </template>
            <template v-else>
              <UiIcon name="bell" class="w-4 h-4 mr-2" />
        ...
        <UiPanel variant="subtle" size="sm" class-name="mt-4">
          <div class="text-xs text-content-secondary dark:text-content-secondary">
            <UiIcon name="shield-check" class="w-4 h-4 inline mr-1" />
