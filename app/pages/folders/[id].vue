...
<template>
    <div class="mt-xl">
        ...
        <div v-if="folder" class="bg-white dark:bg-foreground ">
            <div class="flex flex-wrap gap-4 justify-between my-4 pb-4">
                ...
                <div class="flex flex-col items-start gap-1">
                    ...
                    <div class="flex justify-between items-center">
                        <button class="btn bg-accent text-foreground" @click="show = true">Upload Materials</button>
                        <modals-upload-material-form :show="show" @cancel="show = false" />
                    </div>
                </div>
            </div>
