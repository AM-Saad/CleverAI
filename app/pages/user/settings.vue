    ...
    <div class="py-6">
      ...
      <div v-if="currentTab?.key === 'study'" class="space-y-6">
        <UCard>
          ...
          <div class="space-y-4">
            <UFormGroup
              label="Default Cards per Session"
              help="How many cards to review in a single session"
            >
              <UInput
                v-model.number="studySettings.defaultSessionSize"
                type="number"
                min="5"
                max="100"
                placeholder="20"
            ...
            <UFormGroup
              ...
              help="Reveal answer without requiring a click"
            >
      ...
      <div v-if="currentTab?.key === 'security'" class="space-y-6">
        <UCard>
          ...
          <div class="space-y-4">
            ...
            <UButton color="error" variant="outline"> Delete Account </UButton>
          </div>
        </UCard>
      </div>
      ...
      <div v-if="currentTab?.key === 'data'" class="space-y-6">
        <UCard>
          ...
          <div class="space-y-4">
            ...
            <UButton color="primary" variant="outline"> Import Data </UButton>
          </div>
        </UCard>
        ...
        <UCard>
          ...
          <div class="space-y-4">
            ...
            <UFormGroup
              ...
              help="Automatically report errors to help fix bugs"
            >
