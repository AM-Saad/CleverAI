    ...
    <div data-testid="offline-page"
        ...
        <div class="text-center max-w-md">
            ...
            <p class="text-gray-300 text-lg mb-8">
                It looks like you've lost your internet connection. Don't worry - some content might still be available.
            </p>
            ...
            <div class="space-y-4">
                ...
                <button
                    ...
                    <svg v-if="isChecking" class="animate-spin -ml-1 mr-3 h-5 w-5 text-white" fill="none"
                        viewBox="0 0 24 24">
