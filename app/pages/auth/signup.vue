...
<template>
  <div
    class="flex items-center justify-center flex-col w-full max-w-xl mx-auto"
  >
    <form
      ref="signup"
      method="post"
    ...
    >
      ...
      <div
        class="mb-2 mt-2 rounded-md relative transition duration-10 00 text-xs"
      >
        <ui-input-field
    ...
    <div
      ...
      class="flex flex-col justify-center mt-4 gap-y-2"
    >
      <UiParagraph size="sm" color="muted">
