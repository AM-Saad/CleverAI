<template>
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 mb-6 animate-fade-in">
        <div class="flex justify-between items-start mb-6">
            <h2 class="text-xl font-bold text-gray-900 dark:text-gray-100">
                Review Analytics
            </h2>
            <button class="text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200 p-1 rounded"
                @click="$emit('close')">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <div class="space-y-3">
                    ...
                    <div class="flex justify-between">
                        <span class="text-sm text-gray-600 dark:text-gray-400">Average Ease Factor:</span>
                        <span class="text-sm font-medium">{{ analytics.performanceMetrics.averageEaseFactor }}</span>
                    </div>
                    <div class="flex justify-between">
                        <span class="text-sm text-gray-600 dark:text-gray-400">Average Interval:</span>
