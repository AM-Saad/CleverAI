...
/**
 * UiDrawer — side-anchored panel (left/right), swipe-to-dismiss, auto-collapses
 * to a bottom sheet under `breakpoint`. Distinct from `UiSheet`, which is always
 * bottom-anchored with no side option. Use UiDrawer only when the surface
 * genuinely needs a side rail (e.g. a persistent-feeling panel); UiSheet is the
 * default for mobile capture/action sheets.
 */
...
const props = withDefaults(defineProps<DrawerProps>(), {
  ...
  title: "Panel",
  backdrop: true,
  backdropClass: "bg-[var(--ds-backdrop-dim)]",
