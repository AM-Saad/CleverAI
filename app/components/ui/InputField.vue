<template>
  <div :class="`form-group min-w-full relative h-14 border border-secondary has-focus-within:border-primary overflow-hidden rounded-[var(--radius-md)] dark:border-muted
      has-focus-within:dark:border-primary dark:text-light 
    ...
    <input :id="props.id" v-model="model" :type="props.type" :name="props.name"
      ...
      :title="props.title" />
    <label :for="props.id" :class="`absolute transition-all duration-300 left-2 text-sm text-content-disabled
