<template>
  <motion.div :initial="{ opacity: 0, height: 0 }" :animate="{ opacity: 1, height: '100%' }" :transition="{
    ...
    class="h-full absolute animate-pulse bg-gradient-to-r blur-lg dark:from-[#00e2ff]/70 dark:to-red-600/40 from-[#00e2ff]/40 right-3 opacity-30 rounded-lg to-red-600/40 transition-all w-[calc(100%-2rem)] will-change-auto">
  </motion.div>
