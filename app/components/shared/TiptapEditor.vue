  ...
  <div v-if="editor" class="container flex flex-col p-0.5">
    <div
      ...
      <div class="button-group flex gap-2 self-end my-1 md:mb-2">
        ...
        <u-button class="shrink-0" variant="subtle" size="sm" @click="editor!.chain().focus().redo().run()"
...
const headingsItems = ref<NavigationMenuItem[]>([
  {
    ...
    children: [
      ...
      },
      {
        ...
        onSelect: () => editor.value!.chain().focus().toggleBold().run(),
      },
      {
        label: "Italic",
        icon: "i-lucide-italic",
        description: "Toggle italic text",
        onSelect: () => editor.value!.chain().focus().toggleItalic().run(),
      },
      {
        label: "Strike",
        icon: "i-lucide-strikethrough",
        description: "Toggle strikethrough text",
        onSelect: () => editor.value!.chain().focus().toggleStrike().run(),
      },
    ],
  },
]);
    ...
    children: [
      {
        ...
        icon: "i-lucide-list-check",
        description: "Turn todo list on/off",
        onSelect: () => editor.value!.chain().focus().toggleTaskList().run(),
      },
      {
        label: "Add Task Item",
        icon: "i-lucide-plus",
        description: "Insert a new task item",
      ...
      },
      {
        ...
        description: "Indent current task",
        onSelect: () =>
      ...
      },
      {
        ...
        description: "Outdent current task",
        onSelect: () =>
    ...
    children: [
      {
        label: "Code block",
        icon: "i-lucide-code",
        description: "Insert or toggle code block",
      ...
      },
      {
        ...
        onSelect: () => editor.value!.chain().focus().setHorizontalRule().run(),
      },
      {
        label: "Hard break",
        icon: "i-lucide-corner-down-right",
        description: "Insert hard break",
        onSelect: () => editor.value!.chain().focus().setHardBreak().run(),
      },
    ],
  },
]);
    ...
    children: [
      {
        ...
        onSelect: () => editor.value!.chain().focus().setColor("#2563EB").run(),
      },
      {
        label: "Secondary",
        icon: "i-lucide-circle",
        description: "Secondary color",
        onSelect: () => editor.value!.chain().focus().setColor("#6B7280").run(),
      },
      {
        label: "Neutral",
        icon: "i-lucide-circle",
        description: "Neutral / dark",
        onSelect: () => editor.value!.chain().focus().setColor("#111827").run(),
      },
      {
        label: "Red",
        icon: "i-lucide-circle",
        description: "Red",
        onSelect: () => editor.value!.chain().focus().setColor("#EF4444").run(),
      },
      {
        label: "Green",
        icon: "i-lucide-circle",
        description: "Green",
        onSelect: () => editor.value!.chain().focus().setColor("#10B981").run(),
      },
      {
        label: "Blue",
        icon: "i-lucide-circle",
        description: "Blue",
        onSelect: () => editor.value!.chain().focus().setColor("#3B82F6").run(),
      },
      {
        label: "Purple",
        icon: "i-lucide-circle",
        description: "Purple",
        onSelect: () => editor.value!.chain().focus().setColor("#8B5CF6").run(),
      },
      {
        label: "Yellow",
        icon: "i-lucide-circle",
        description: "Yellow",
        onSelect: () => editor.value!.chain().focus().setColor("#F59E0B").run(),
      },
    ],
  },
]);
