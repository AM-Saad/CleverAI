<template>
  <div v-if="isDev" class="fixed bottom-4 right-4 z-50">
    ...
    <button v-if="!showPanel"
      ...
      <UiIcon name="flask-conical" class="w-6 h-6" />
    </button>
    ...
    <div v-if="showPanel"
      ...
      <div class="flex justify-between items-center mb-4">
        <h2 class="text-lg font-semibold text-gray-900 dark:text-gray-100 flex items-center">
          <UiIcon name="flask-conical" class="w-5 h-5 mr-2 text-purple-600" />
          🧪 Testing Dashboard
        </h2>
        ...
        <div>
          ...
          <div class="space-y-2">
            <button @click="triggerCron" :disabled="isTriggering"
              ...
              <UiIcon v-if="isTriggering" name="refresh-cw" class="w-4 h-4 mr-2 animate-spin" />
