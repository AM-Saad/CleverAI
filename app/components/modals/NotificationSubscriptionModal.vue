<template>
    <Teleport to="body">
        ...
        <UiDialogModal :show="showModal">
                    ...
                    <div class="flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <div class="text-xs text-gray-600 dark:text-gray-400">
                                Get notified exactly when cards are due for optimal memory retention
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start gap-2">
                        ...
                        <div>
                            ...
                            <div class="text-xs text-red-600 dark:text-red-300 mt-1">
                                Please click the lock icon in your browser's address bar and allow notifications for
                                this
                                site.
                            </div>
                        </div>
            ...
            <template #footer>
                <div class="space-y-3">
                    <UButton :loading="isLoading" :disabled="permissionStatus === 'denied'" color="primary" size="lg"
                        block @click="handleEnableNotifications">
                ...
                <div class="mt-4 p-3 bg-gray-50 dark:bg-gray-800/50 rounded-lg">
                    <div class="text-xs text-gray-600 dark:text-gray-400">
                        ...
                        Your notification preferences are stored locally and can be changed anytime in Settings.
                    </div>
                </div>
            </template>
        </UiDialogModal>
...
const { registerNotification, isLoading, error, checkPermission } = useNotifications()
...
const handleEnableNotifications = async () => {
    try {
        ...
        toast.add({
            ...
            description: 'You\'ll now receive smart study reminders. You can customize them in Settings.',
            color: 'success'
        })
        ...
        if (import.meta.client) {
            localStorage.setItem('notificationPrompted', JSON.stringify({
                timestamp: Date.now(),
                action: 'subscribed'
            }))
        }
