<template>
    <div
        class="sticky top-0 z-10 bg-light dark:bg-gray-800  border-b border-gray-200 dark:border-gray-700 flex items-center gap-4">
        <u-input v-model="search" placeholder="Search in notes" type="text"  :ui="{
            base: 'border-0 ring-0 h-10'
        }" />
...
watch(filteredNoteIds, (newFilteredIds) => {
