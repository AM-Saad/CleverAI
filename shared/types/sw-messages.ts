...
// SW lifecycle & update
export interface SwActivatedMessage { type: typeof SW_MESSAGE_TYPES.SW_ACTIVATED; version: string }
export interface SwControlClaimedMessage { type: typeof SW_MESSAGE_TYPES.SW_CONTROL_CLAIMED }
export interface SwUpdateAvailableMessage { type: typeof SW_MESSAGE_TYPES.SW_UPDATE_AVAILABLE; version: string }
...
// ---------------- Incoming (Window -> SW) ----------------
export interface SkipWaitingMessage { type: typeof SW_MESSAGE_TYPES.SKIP_WAITING }
export interface ClaimControlMessage { type: typeof SW_MESSAGE_TYPES.CLAIM_CONTROL }
export interface SetDebugMessage { type: typeof SW_MESSAGE_TYPES.SET_DEBUG; value: boolean }
export interface SyncNotesMessage { type: typeof SW_MESSAGE_TYPES.SYNC_NOTES }
...
// Utility type guards (narrowing helpers) ---------------------------------
export function isOutgoingSWMessage(msg: unknown): msg is OutgoingSWMessage {
  return !!msg && typeof (msg as { type?: unknown }).type === 'string'
}

export function isIncomingSWMessage(msg: unknown): msg is IncomingSWMessage {
  return !!msg && typeof (msg as { type?: unknown }).type === 'string'
}
...
// Public aggregate namespaces (optional re-export buckets)
