...
| Document                                                        | Description                                                           |
| --------------------------------------------------------------- | --------------------------------------------------------------------- |
| **[🔍 AI_AUDIT.md](./AI_AUDIT.md)**                             | Bottom-up/top-down review, SOLID assessment, findings, remaining risk |
| **[🔄 LLM_GENERATION_FLOW.md](./LLM_GENERATION_FLOW.md)**       | OpenRouter-only inference flow, invariants, failures, audit, cleanup  |
