...
export const languageStoryPrompt = (
  ...
  context?: string,
  relatedWords: string[] = [],
  learnedLanguage = "the language being learned",
  nativeLanguage = "the learner's native language",
) => `
You are a language learning assistant. Create exactly 3 short, natural sentences forming a coherent micro-story or dialogue.
...
- Write ALL of title, storyText, sentences[].text, clozeWord, clozeBlank, glossary words, and ttsText in ${learnedLanguage}
- Never write storyText or sentence text in ${nativeLanguage}
- Do not return a native-language version of the story
- Use ${nativeLanguage} ONLY for glossary translations
