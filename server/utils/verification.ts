...
export async function assertRegisterCode(
  user: { register_verification: string | null },
  code: string
) {
...
export async function assertPasswordCode(
  user: { password_verification: string | null },
  code: string
) {
