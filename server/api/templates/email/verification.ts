...
export const generateVerificationEmail = (data: VerificationEmailData): EmailTemplate => {
  ...
  const content = `
    ${generateHeader('Ibrahim Learning Platform', 'Email Verification Required')}
    ...
    <div style="background-color: #f8fafc; ${baseStyles.contentBox}">
      ...
      <p style="${baseStyles.text}">
        Welcome to Ibrahim Learning Platform! Please use the verification code below to complete your registration:
      </p>
    ...
    <div style="${baseStyles.footer}">
      <p style="${baseStyles.footerText}">
        If you didn't create an account with Ibrahim Learning Platform, please ignore this email.
      </p>
  ...
  return {
    subject: 'Email Verification - Ibrahim Learning Platform',
