...
import { FORM_SYNC_TYPES, type FormSyncType } from "~/shared/constants/offline"
...
export default defineEventHandler(async (event) => {
  ...
  for (const record of records) {
    ...
    try {
      ...
      console.log(`✅ Form sync successful: ${type} for user ${user.email}`, { id, payload })
      
    } catch (error) {
      console.error(`❌ Form sync failed: ${type} for user ${user.email}`, { id, error })
      errors.push({
        id,
        type,
...
// ===== MATERIAL HANDLERS =====
async function handleMaterialUpload(payload: Record<string, unknown>, user: { id: string; email: string }, prisma: any) {
  const { materialTitle, materialContent, materialType, folderId } = payload
  
  if (!materialTitle || !materialContent || !folderId) {
    throw new Error('Missing required fields: materialTitle, materialContent, or folderId')
  }
...
async function handleMaterialUpdate(payload: Record<string, unknown>, user: any, prisma: any) {
...
async function handleMaterialDelete(payload: Record<string, unknown>, user: any, prisma: any) {
...
// ===== FOLDER HANDLERS =====
async function handleFolderCreate(payload: Record<string, unknown>, user: any, prisma: any) {
...
async function handleFolderUpdate(payload: Record<string, unknown>, user: any, prisma: any) {
...
async function handleFolderDelete(payload: Record<string, unknown>, user: any, prisma: any) {
...
// ===== NOTE HANDLERS =====
async function handleNoteCreate(payload: Record<string, unknown>, user: any, prisma: any) {
...
async function handleNoteUpdate(payload: Record<string, unknown>, user: any, prisma: any) {
...
async function handleNoteDelete(payload: Record<string, unknown>, user: any, prisma: any) {
...
// ===== REVIEW HANDLERS =====
async function handleCardEnroll(_payload: Record<string, unknown>, _user: any, _prisma: any) {
...
async function handleCardGrade(_payload: Record<string, unknown>, _user: any, _prisma: any) {
  // Implementation for card grading
  throw new Error('Card grading sync not yet implemented')
}

async function handleCardUnenroll(_payload: Record<string, unknown>, _user: any, _prisma: any) {
  // Implementation for card unenrollment
  throw new Error('Card unenrollment sync not yet implemented')
}

// ===== USER PREFERENCE HANDLERS =====
async function handlePreferencesUpdate(_payload: Record<string, unknown>, _user: any, _prisma: any) {
  // Implementation for user preferences update
  throw new Error('Preferences update sync not yet implemented')
}

async function handleNotificationSettingsUpdate(_payload: Record<string, unknown>, _user: any, _prisma: any) {
